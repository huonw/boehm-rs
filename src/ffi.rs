...
pub type GC_has_static_roots_func =
    extern "C" fn(arg1: *const c_schar, arg2: *mut c_void, arg3: size_t) -> c_int;
...
extern "C" {
    ...
    pub fn GC_debug_malloc_atomic_uncollectable(arg1: size_t, s: *const c_schar,
                                                i: c_int) -> *mut c_void;
    pub fn GC_debug_malloc(arg1: size_t, s: *const c_schar, i: c_int) ->
     *mut c_void;
    pub fn GC_debug_malloc_atomic(arg1: size_t, s: *const c_schar, i: c_int) ->
     *mut c_void;
    pub fn GC_debug_strdup(arg1: *const c_schar, s: *const c_schar, i: c_int) ->
     *mut c_schar;
    pub fn GC_debug_strndup(arg1: *const c_schar, arg2: size_t, s: *const c_schar,
                            i: c_int) -> *mut c_schar;
    pub fn GC_debug_malloc_uncollectable(arg1: size_t, s: *const c_schar, i: c_int)
     -> *mut c_void;
    pub fn GC_debug_malloc_stubborn(arg1: size_t, s: *const c_schar, i: c_int) ->
     *mut c_void;
    pub fn GC_debug_malloc_ignore_off_page(arg1: size_t, s: *const c_schar,
                                           i: c_int) -> *mut c_void;
    pub fn GC_debug_malloc_atomic_ignore_off_page(arg1: size_t, s: *const c_schar,
                                                  i: c_int) -> *mut c_void;
    pub fn GC_debug_free(arg1: *mut c_void);
    pub fn GC_debug_realloc(arg1: *mut c_void, arg2: size_t, s: *const c_schar,
                            i: c_int) -> *mut c_void;

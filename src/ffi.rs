...
pub type GC_finalization_proc = extern "C" fn(arg1: *mut c_void, arg2: *mut c_void);
...
pub type GC_stack_base_func = extern "C" fn(arg1: *mut Struct_GC_stack_base, arg2: *mut c_void)
                                            -> *mut c_void;
pub type GC_has_static_roots_func = extern "C" fn(arg1: *const c_schar,
                                                  arg2: *mut c_void,
                                                  arg3: size_t)
                                                  -> c_int;
...
extern "C" {
    ...
    pub static mut GC_same_obj_print_proc: extern "C" fn(arg1: *mut c_void, arg2: *mut c_void);
    pub static mut GC_is_valid_displacement_print_proc: extern "C" fn(arg1: *mut c_void);
    ...
    pub fn GC_strdup(arg1: *const c_schar) -> *mut c_schar;
    pub fn GC_strndup(arg1: *const c_schar, arg2: size_t) -> *mut c_schar;
    ...
    pub fn GC_posix_memalign(arg1: *mut *mut c_void, arg2: size_t, arg3: size_t) -> c_int;
    ...
    pub fn GC_get_heap_usage_safe(arg1: *mut GC_word,
                                  arg2: *mut GC_word,
                                  arg3: *mut GC_word,
                                  arg4: *mut GC_word,
                                  arg5: *mut GC_word);
    ...
    pub fn GC_debug_malloc_atomic_uncollectable(arg1: size_t,
                                                ...
                                                i: c_int)
                                                -> *mut c_void;
    pub fn GC_debug_malloc(arg1: size_t, s: *const c_schar, i: c_int) -> *mut c_void;
    pub fn GC_debug_malloc_atomic(arg1: size_t, s: *const c_schar, i: c_int) -> *mut c_void;
    pub fn GC_debug_strdup(arg1: *const c_schar, s: *const c_schar, i: c_int) -> *mut c_schar;
    pub fn GC_debug_strndup(arg1: *const c_schar,
                            arg2: size_t,
                            s: *const c_schar,
                            i: c_int)
                            -> *mut c_schar;
    pub fn GC_debug_malloc_uncollectable(arg1: size_t, s: *const c_schar, i: c_int) -> *mut c_void;
    pub fn GC_debug_malloc_stubborn(arg1: size_t, s: *const c_schar, i: c_int) -> *mut c_void;
    ...
    pub fn GC_debug_realloc(arg1: *mut c_void,
                            arg2: size_t,
                            s: *const c_schar,
                            i: c_int)
                            -> *mut c_void;
    ...
    pub fn GC_debug_realloc_replacement(arg1: *mut c_void, arg2: size_t) -> *mut c_void;
    ...
    pub fn GC_call_with_alloc_lock(arg1: GC_fn_type, arg2: *mut c_void) -> *mut c_void;
    pub fn GC_call_with_stack_base(arg1: GC_stack_base_func, arg2: *mut c_void) -> *mut c_void;
    pub fn GC_do_blocking(arg1: GC_fn_type, arg2: *mut c_void) -> *mut c_void;
    pub fn GC_call_with_gc_active(arg1: GC_fn_type, arg2: *mut c_void) -> *mut c_void;
    ...
    pub fn GC_pre_incr(arg1: *mut *mut c_void, arg2: ptrdiff_t) -> *mut c_void;
    pub fn GC_post_incr(arg1: *mut *mut c_void, arg2: ptrdiff_t) -> *mut c_void;
    ...
    pub fn GC_malloc_explicitly_typed(arg1: size_t, arg2: GC_descr) -> *mut c_void;
    pub fn GC_malloc_explicitly_typed_ignore_off_page(arg1: size_t, arg2: GC_descr) -> *mut c_void;
    pub fn GC_calloc_explicitly_typed(arg1: size_t, arg2: size_t, arg3: GC_descr) -> *mut c_void;
}
